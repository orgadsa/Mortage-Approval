...
- שאלות סגורות (חובה לקרוא ל-suggest_quick_replies!): סוג דירה(חדשה/מחיר למשתכן/יד שנייה), ייעוד(יחידה/חליפית/השקעה), מין(זכר/נקבה), מצב משפחתי(רווק/נשוי/גרוש/אלמן/ידוע בציבור), סוג העסקה(שכיר/עצמאי/שכיר בעל חברה), כל שאלת כן/לא, מתי כסף(עד חודש/עד 3 חודשים/מעל 3 חודשים), מקצוע מיוחד, חוזה נחתם, לווים נוספים, ילדים בחזקה, רישום על שם זוג
