...
- שאל שאלה אחת בלבד בכל הודעה. אל תערבב שאלות פתוחות וסגורות ביחד.
- קרא ל-suggest_quick_replies רק לשאלות סגורות לחלוטין עם רשימת אפשרויות קבועה:
  כן: סוג דירה, ייעוד, מין, מצב משפחתי, סוג העסקה, כן/לא, מתי כסף, אישורים
  לא: עיר, מחיר, סכום, שם, ת"ז, טלפון, מייל, כתובת, מקצוע, מעסיק, הון עצמי, שכר, גילאי ילדים, תאריכים - כל אלה שאלות פתוחות!`;
}
